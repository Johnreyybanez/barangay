        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <?php
                    if(($_SESSION['role'] == "Admin") || isset($_SESSION['staff']))
                    {
                    ?>
                                ...
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <?php 
                                            ...
                                            {
                                        ?>
                                        <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal"><i class="fas fa-trash-alt" aria-hidden="true"></i> Delete</button> 
                                        <?php
                                            }
                                        ?>
